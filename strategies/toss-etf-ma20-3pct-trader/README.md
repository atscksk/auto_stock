...
```bash
node strategies/toss-etf-ma20-3pct-trader/signal.js
```
...
```bash
node strategies/toss-etf-ma20-3pct-trader/order.js
```
...
```text
strategies/toss-etf-ma20-3pct-trader/logs/signals.jsonl
strategies/toss-etf-ma20-3pct-trader/logs/order-plans.jsonl
strategies/toss-etf-ma20-3pct-trader/logs/orders.jsonl
strategies/toss-etf-ma20-3pct-trader/logs/portfolio.jsonl
strategies/toss-etf-ma20-3pct-trader/logs/errors.jsonl
```
...
```cron
40 15 * * 1-5 cd /path/to/auto_stock && /usr/bin/node strategies/toss-etf-ma20-3pct-trader/signal.js
```
...
```cron
40 15 * * 1-5 cd /path/to/auto_stock && /usr/bin/node strategies/toss-etf-ma20-3pct-trader/signal.js
5 9 * * 1-5 cd /path/to/auto_stock && /usr/bin/node strategies/toss-etf-ma20-3pct-trader/order.js
```
...
```js
import { ma20Strategy } from './strategies/toss-etf-ma20-3pct-trader/src/strategy.js';
